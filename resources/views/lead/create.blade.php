<div class="kt-portlet__body">
    <div class="row">
        ...
        <div class="form-group col-lg-2">
            <label>Name:</label>
            <input type="text" class="form-control name" placeholder="Enter Name" id="name" name="name" required>
        </div>
         <div class="form-group col-lg-2">
            <label>Number:</label>
            <input type="number" class="form-control number" placeholder="Enter Number" id="number" name="number">
        </div>
         <div class="form-group col-lg-2">
            <label>Email:</label>
            <input type="text" class="form-control email" placeholder="Enter Email" id="email" name="email">
        </div>
         <div class="form-group col-lg-2">
            <label>Image:</label>
            <input type="file" class="form-control image" placeholder="Enter" id="image" name="image">
        </div>
