				...
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">					
						...
						<form id="userimportform" enctype="multipart/form-data">
							...
							<button type="submit" class="btn btn-brand btn-elevate btn-icon-sm gstimport">
								<i class="la la-upload"></i>
								Import
							</button>

							<a href="{{route('gst_export')}}" class="btn btn-brand btn-elevate btn-icon-sm">
								<i class="la la-download"></i>
								Export
							</a>

							<a href="{{route('gst.create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
