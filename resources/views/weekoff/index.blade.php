			...
			<div class="kt-portlet__head-toolbar">
				<div class="kt-portlet__head-wrapper">
					<div class="kt-portlet__head-actions">					
                		...
                		@if(Auth::user()->role == 1)
						<a href="{{route('weekoff.create')}}" class="btn btn-brand btn-elevate btn-icon-sm">
							<i class="la la-plus"></i>
							Add
						</a>
						@endif
						<a href="{{route('holiday.index')}}" class="btn btn-brand btn-elevate btn-icon-sm">
